      ...
      <section class="section featured-car" id="featured-car">
        <div class="container">
          ...
          <div class="title-wrapper">
            ...
            <a href="allcars.php" class="featured-car-link">
              <span>View more</span>
              ...
              <div class="featured-car-card">
                ...
                <div class="card-content">
                  ...
                  <div class="card-price-wrapper">
                    ...
                    <a href="login.php"><button class="btn">Rent now</button></a>
          ...
          <ul class="get-start-list">
            ...
            <li>
              <div class="get-start-card">
                ...
                <p class="card-text">
                  Register with us to rent a car and live free!!.
                </p>

                <a href="registration.php" class="card-link">Get started</a>
