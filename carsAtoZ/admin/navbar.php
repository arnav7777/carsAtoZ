    ...
    <div class="container">
      ...
      <nav class="navbar" data-navbar>
        <ul class="navbar-list">
          ...
          <li>
            <a href="carpanel.php?id=<?php echo $id;?>" class="navbar-link" data-nav-link>Your cars</a>
          </li>
          <li>
      ...
      <div class="header-actions">
        ...
        <a href="addcar.php?id=<?php echo $id?>" class="btn" aria-labelledby="aria-label-txt">
